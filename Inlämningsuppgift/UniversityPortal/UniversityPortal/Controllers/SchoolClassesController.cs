...
namespace UniversityPortal.Controllers
{
    ...
    public class SchoolClassesController : Controller
    {
        ...
        public SchoolClassesController(UniversityDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index()
        {
            ...
            foreach (var schoolClass in classes)
            {
                ...
                schoolClass.SchoolClassStudents = await _context.SchoolClassStudents.ToListAsync();
            }
        ...
        public async Task<IActionResult> Create([Bind("Id,ClassName,TeacherId,ClassStart,ClassEnd")] SchoolClass schoolClass)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ClassName,TeacherId,ClassStart,ClassEnd, SchoolClassStudents")] SchoolClass schoolClass)
        {
