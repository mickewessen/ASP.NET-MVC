...
namespace UniversityPortal.Controllers
{
    public class SchoolClassStudentsController : Controller
    {
        ...
        public SchoolClassStudentsController(UniversityDbContext context, UserManager<ApplicationUser> userManager)
        {
            _context = context;
        ...
        {
            var universityDbContext = _context.SchoolClassStudents.Include(s => s.SchoolClass);
